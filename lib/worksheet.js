      ...
      this.workBook._parseXML.call(
        ...
        () => {
          if (this.workingRow.name) {
            ...
            this.workingRow.name = undefined;
      ...
      if (workingCell.name === "c") {
        ...
        switch (workingCell.attributes.t) {
          case "s":
            ...
            // todo check if need to throw on undefined workingval (removed || '')
            // this.workingRow.values[cellNum] = workingVal;
            break;
          case "inlineStr":
            // inline string
            // todo check if I was right to change this: nodeData.shift() || "";
            // this.workingRow.values[cellNum] = workingVal;
            break;
          case "str":
          // string (formula)
          ...
          // number
          // const _tempNumber = parseFloat(workingVal);
          // this.workingRow.values[cellNum] = Number.isNaN(_tempNumber)
          //   ? ""
          //   : _tempNumber;
          // workingCell = {};
          // break;
          ...
          default:
            ...
            if (
              ...
              } else if (!Number.isNaN(parseFloat(workingVal))) {
                // this is number
                workingVal = parseFloat(workingVal); // parse to float or int
              }
            }
        }
        this.workingRow.values[cellNum] = workingVal === undefined ? "" : workingVal;
        workingCell = {};
      }
